...
async function getDescriptionRequest(symbol, filePath, lineNumber) {
  try {
    const response = await axios_default.get(
      `${getExtensionUrl()}/api/getDescription`,
      {
        headers: {
          "Content-Type": "application/json"
        },
...
var getTools = [
  ...
  },*/
  {
    ...
    description: "Get documentation relevant to the specified symbol. It can be a function, a class, or a variable. Use this when wanting to understand something, for example for testing or explanation purposes.",
    inputSchema: {
      type: "object",
      properties: {
        symbol: {
          type: "string",
          description: "Symbol name as it appears in the its declaration in the code. In the case of functions this should contain its name and its parameters, including the parentheses, exactly as they appear in the function declaration in the code, as the symbol will be searched via string comparison."
        },
        filePath: {
          type: "string",
          description: "The relative or absolute file path of the file, where the symbol is declared. NOT where its used, but where its declared."
        },
        lineNumber: {
          type: "integer",
          description: "The line number where the symbol is declared. NOT where its used, but where its declared."
        }
      },
